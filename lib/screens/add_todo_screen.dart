...
class _AddTodoScreenState extends State<AddTodoScreen> {
  //formkey is useful when we want to validate field in our form,
  //it allows us to save current state in our form
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  // late keyword shows that we will initialize controller later
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      primary:
                          !_isEditing ? Color(0xff000000) : Color(0xff000000),
